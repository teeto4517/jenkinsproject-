...
import idecpageelements.Admin_approval;
import idecpageelements.ldecloginelements;

public class Scheduling_Offical_approval {
...
static WebDriver driver =null;
	...
	@Test
	public void Scheduling_offical_Approval () {
		...
		locateElements.loginMethod("schedule@idec.com","admin");
		
		test.log(LogStatus.INFO, "Login with Valid user credentials");
	
		Admin_approval Elements = PageFactory.initElements(driver, Admin_approval.class);
		
		Elements.Approve_application("Approved");
	}
