...
public class ApplicantInvalidlogin {
static WebDriver driver =null;
	...
	public void Invoke_browser() {
		...
		test = report.startTest("IDEC Login Verification (Invalid)");
	...
	public void login() throws InterruptedException {
		...
		locateElements.loginMethod("test@gmail.com","password1");
		
		test.log(LogStatus.INFO, "Login credentials Entered");
		
		assertTrue(locateElements.InvalidLogin());
